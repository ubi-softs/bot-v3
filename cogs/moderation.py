...
class Moderation(commands.Cog):
    """All commands live under /mod so this cog only costs 1 slash-command slot."""
    ...
    # ── /mod unban ────────────────────────────────────────────
    @mod_group.command(name="unban", description="Unban a user by their ID")
    ...
    # ── /mod softban ──────────────────────────────────────────
    @mod_group.command(name="softban", description="Ban then immediately unban a member (wipes their messages)")
    ...
    # ── /mod untimeout ────────────────────────────────────────
    @mod_group.command(name="untimeout", description="Remove a timeout from a member")
    ...
    # ── /mod delwarn ──────────────────────────────────────────
    @mod_group.command(name="delwarn", description="Delete a single warning by its number")
    @app_commands.describe(member="Member", index="Warning number shown in /mod warnings (starts at 1)")
    ...
    # ── /mod clearwarnings ────────────────────────────────────
    @mod_group.command(name="clearwarnings", description="Clear all warnings for a member")
    ...
    # ── /mod lock ─────────────────────────────────────────────
    @mod_group.command(name="lock", description="Lock a channel so members can't send messages")
    ...
    # ── /mod roleadd, /mod roleremove ──────────────────────────
    @mod_group.command(name="roleadd", description="Add a role to a member")
    ...
    @mod_group.command(name="roleremove", description="Remove a role from a member")
    ...
    # ── /mod giveroles (online members) ────────────────────────
    @mod_group.command(name="giveroles", description="Give the Active Member role to all online members")
    @app_commands.checks.has_permissions(manage_roles=True)
    async def giveroles(self, interaction: discord.Interaction):
        ...
        if not role:
            role = await guild.create_role(name="Active Member", reason="/mod giveroles")
    ...
    # ── /mod lockdown, /mod unlockdown ────────────────────────
    @mod_group.command(name="lockdown", description="Lock ALL channels in the server")
    ...
    @mod_group.command(name="unlockdown", description="Unlock ALL channels in the server")
    @app_commands.checks.has_permissions(administrator=True)
    ...
    # ── /mod modlogs ──────────────────────────────────────────
    @mod_group.command(name="modlogs", description="View a member's full moderation history (warnings)")
